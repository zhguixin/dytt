...
public class URLEncode {
    ...
    // 转换为迅雷的下载地址，参考这个网址：http://www.ccav1.com/mui2/url.htm 提供的小工具
    public static String thunderEncode(String link) {
        String thunderPrefix = "AA";
        String thunderPosix = "ZZ";
        String thunderTitle = "thunder://";
        byte[] tempLink = (thunderPrefix + link + thunderPosix).getBytes();
        return thunderTitle + base64encode(tempLink);
    }
